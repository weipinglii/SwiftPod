...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/weiping.li/SwiftPod'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'weiping.li' => 'weiping.li@ximalaya.com' }
  s.source           = { :git => 'https://github.com/weiping.li/SwiftPod.git', :tag => s.version.to_s }
